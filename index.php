...
<html lang="en" class="gr__ide50-wizard-of-programming_cs50_io"><head>
    ...
    <meta name="description" content="Sagar Bansal">
    <meta name="keywords" content="PriSag">
    <meta name="author" content="PriSag">

    <title>Sagar Bansal - Online Portfolio</title>

    <!-- Bootstrap core CSS -->
    <link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/vendor/font-mfizz-2.4.1/dist/font-mfizz.css">
    ...
    <link rel="shortcut icon" href="static/images/prisag.png" type="image/x-icon">
    <link rel="apple-touch-icon" href="static/images/prisag.png">
    <style type="text/css" scoped>.bae:hover { color:#bae; } p{font-size:12px;}</style>
  </head>
          ...
          <div class="col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item">
                <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://github.com/sagban">
